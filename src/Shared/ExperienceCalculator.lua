-- @author Quenty
-- https://github.com/Quenty/NevermoreEngine/blob/master/Modules/Utility/ExperienceCalculator.lua
local ExperienceCalculator = {}
local ExperienceFactor = 20
...
local function GetLevelFromExperience(Experience)
    ...
    return math.floor((ExperienceFactor +
                      math.sqrt(ExperienceFactor * ExperienceFactor - 4 * ExperienceFactor *
                                (-Experience))) / (2 * ExperienceFactor))
end
